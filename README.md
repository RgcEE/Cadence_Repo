...
Simulations run via Spectre/SPICE with BSIM4 device models on the University of Idaho ECE server.
...
### Sense Amplifier (`sense_amp_bsim4`)
Latch-type SRAM sense amplifier characterization using BSIM4 models.
...
```
cadence_repo/
├── sense_amp_bsim4/        # Sense amplifier project
...
├── models/                 # Shared BSIM4 model files
└── README.md
```
